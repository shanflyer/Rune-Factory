...
namespace UnityEditor.UI
{
    ...
    public class SliderEditor : SelectableEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            m_gradientColor = serializedObject.FindProperty("gradientColor");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_FillRect.objectReferenceValue != null || m_HandleRect.objectReferenceValue != null)
            {
                ...
                EditorGUILayout.PropertyField(m_gradient,new GUIContent("ValueColor"));
                EditorGUILayout.PropertyField(m_gradientColor, new GUIContent("ChangeColor"));

...
{
    /// <summary>
    ///     Abstract class that is used by systems to encapsulate Sprite data representation. Currently this is used by
    ...
    public class SpriteRect
    {
        ...
        internal string originalName
        {
            get
            {
                if (m_OriginalName == null) m_OriginalName = name;
    ...
    {
        [SerializeField] private List<SpriteRect> m_Rects;

        public int Count => m_Rects != null ? m_Rects.Count : 0;

...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public partial class DrawObjectsPass : ScriptableRenderPass
    {
        ...
        public DrawObjectsPass(string profilerTag, ShaderTagId[] shaderTagIds, bool opaque, RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference)
            : this(profilerTag, shaderTagIds, opaque, evt, renderQueueRange, layerMask, stencilState, stencilReference, Vector3.forward, TransparencySortMode.Default)
        {
        }
        ...
        public DrawObjectsPass(string profilerTag, bool opaque, RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference)
            : this(profilerTag, null, opaque, evt, renderQueueRange, layerMask, stencilState, stencilReference, Vector3.forward, TransparencySortMode.Default)
        {
        }
        ...
        internal DrawObjectsPass(URPProfileId profileId, bool opaque, RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState, int stencilReference)
            : this(profileId, opaque, evt, renderQueueRange, layerMask, stencilState, stencilReference, Vector3.forward, TransparencySortMode.Default)
        {
        }
    ...
    internal class DrawObjectsWithRenderingLayersPass : DrawObjectsPass
    {
        ...
        public DrawObjectsWithRenderingLayersPass(URPProfileId profilerTag, bool opaque, RenderPassEvent evt, RenderQueueRange renderQueueRange, LayerMask layerMask, StencilState stencilState,
            int stencilReference, Vector3 transparencySortAxis, TransparencySortMode transparencySortMode = TransparencySortMode.Default) :

...
public partial class @MyInput: IInputActionCollection2, IDisposable
{
    ...
    ~@MyInput()
    {
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, MyInput.UI.Disable() has not been called.");
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, MyInput.Player.Disable() has not been called.");
        Debug.Assert(!m_Other.enabled, "This will cause a leak and performance issues, MyInput.Other.Disable() has not been called.");
    }

...
namespace VoxelBusters.EssentialKit
{
    internal class RateMyAppPresenter
    {
        ...
        public RateMyAppPresenter(RateMyAppConfirmationDialogSettings settings, Action<RateMyAppConfirmationPromptActionType> onConfirmationPromptAction)
        {
        ...
        {
            m_nativeInterface.RequestStoreReview();
        }

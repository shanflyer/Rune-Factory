...
namespace VoxelBusters.EssentialKit
{
    internal class RateMyAppController
    {
        ...
        public RateMyAppController(RateMyAppUnitySettings settings)
        {
            // initialise
            m_settings                          = settings;
            m_presenter                         = new RateMyAppPresenter(settings.ConfirmationDialogSettings, OnConfirmationDialogAction);

...
namespace VoxelBusters.EssentialKit.BillingServicesCore.Android
{
    public class NativeBillingProductSubscriptionInfo : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeBillingProductSubscriptionInfo(string groupId, string localizedGroupTitle, int level, NativeBillingPeriod period) : base(Native.kClassName ,groupId, localizedGroupTitle, level, period)
        {
        }

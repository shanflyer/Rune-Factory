...
namespace VoxelBusters.EssentialKit.BillingServicesCore.Android
{
    public class NativeBillingPrice : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeBillingPrice(double price, string currencyCode, string currencySymbol, string localizedDisplay) : base(Native.kClassName ,price, currencyCode, currencySymbol, localizedDisplay)
        {
        }

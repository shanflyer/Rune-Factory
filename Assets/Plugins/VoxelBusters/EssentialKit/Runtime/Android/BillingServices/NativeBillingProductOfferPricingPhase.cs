...
namespace VoxelBusters.EssentialKit.BillingServicesCore.Android
{
    public class NativeBillingProductOfferPricingPhase : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeBillingProductOfferPricingPhase(NativeBillingPrice price, NativeBillingProductOfferPaymentMode paymentMode, NativeBillingPeriod period, int repeatCount) : base(Native.kClassName ,price, paymentMode, period, repeatCount)
        {
        }

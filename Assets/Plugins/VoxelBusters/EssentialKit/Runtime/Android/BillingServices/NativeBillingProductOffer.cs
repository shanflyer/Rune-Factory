...
namespace VoxelBusters.EssentialKit.BillingServicesCore.Android
{
    public class NativeBillingProductOffer : NativeAndroidJavaObjectWrapper
    {
        ...
        public NativeBillingProductOffer(string id, NativeBillingProductOfferCategory category, NativeList<NativeBillingProductOfferPricingPhase> pricingPhases) : base(Native.kClassName ,id, category, pricingPhases)
        {
        }

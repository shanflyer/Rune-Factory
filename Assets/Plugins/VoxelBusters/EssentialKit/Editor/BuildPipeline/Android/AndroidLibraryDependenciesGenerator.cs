...
namespace VoxelBusters.EssentialKit.Editor.Build.Android
{
	...
	public class AndroidLibraryDependenciesGenerator
	{
		...
		private static readonly string PlayServicesVersionString		= "20.0.0+";
		...
		private static readonly string PlayCoreInAppUpdateVersionString	=  "2.1.0";   //implementation 'com.google.android.play:app-update:2.1.0'

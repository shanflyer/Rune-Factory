	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 lerpResult119 = lerp( ( _Color2 * tex2DNode197 ) , ( tex2DNode197 * _Color1 ) , 
				saturate( ( texCoord128.y + (-1.0 + (_Color1Level - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) ) ));
				
	 
				float3 Color =  (tex2DNode197* lerpResult119 ).rgb;
                ...
                InitializeInputData(uv_TextureSample1 , ScreenUV75_g2, inputData);
		...
		Pass
		{
				 ...
				 )
			{
                ...
                float3 normalWS = IN.normalWS;
				outNormalWS = half4(NormalizeNormalPerPixel(normalWS), tex2DNode197.a);
				 ...
				 float b=outNormalWS.z;
				 float g=outNormalWS.y;
				// outNormalWS.y=b;
				 //outNormalWS.z=g;
                
				//clip(tex2DNode197.a-0.2);
			}

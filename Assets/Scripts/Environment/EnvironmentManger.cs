...
public class EnvironmentManger : Singleton<EnvironmentManger>
{
    ...
    private SkyEnviromentMono skyEnviromentMono;

    public SkyEnviromentMono SkyEnviromentMono => skyEnviromentMono;
    private ProFlare flare => skyEnviromentMono.ProFlare;
    private Transform sunTransform => skyEnviromentMono.Sun;

    private MyDic<int, MySpriteShadow> shadows = new MyDic<int, MySpriteShadow>();

    private Dictionary<int, MyLight> lights = new Dictionary<int, MyLight>();
    private List<int> lightIds = new List<int>();

    private MyDic<int, Audio2DPolygon> audio2DPolygons = new MyDic<int, Audio2DPolygon>();
    ...
    private FootstepDataList FootstepDataList;
    ...
    private MyDic<int, CharacterFootStep> CharacterFootStepDic = new MyDic<int, CharacterFootStep>();
    ...
    private WeatherDisplayType weatherDisplayType;
    ...
    private IEnumerator LerpWeather(Weather newWeather)
    {
        float timeValue = 0;
        bool oldDamp = !nowWeather.IsSnow() && nowWeather.waterFall > 0;
    ...
    private void RefreshEnvironment(float weatherLightValue, float flareLight)
    {
    ...
    internal class Lightning
    {
        ...
        private float waitLightningTime = 0;
        private float LightningCD = 0;

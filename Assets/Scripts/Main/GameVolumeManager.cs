...
public class GameVolumeManager : Singleton<GameVolumeManager>
{
    ...
    private MyDic<int, GameVolumeObject> volumeObjects = new MyDic<int, GameVolumeObject>();
    private Dictionary<string, ParticleSystem> singleParticleDic = new Dictionary<string, ParticleSystem>();
    ...
    private void LerpScreenCycleValue(LerpScreenCycleValue LerpScreenCycleValue)
    {
        IEnumerator enumerator = LerpCycleValue(LerpScreenCycleValue);
        GameObjectCurveController.instance.StartIEnumerator(enumerator);
    }

    private IEnumerator LerpCycleValue(LerpScreenCycleValue LerpScreenCycleValue)
    {

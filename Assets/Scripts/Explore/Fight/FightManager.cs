...
public class FightManager : Singleton<FightManager>
{
    ...
    public override IReadOnlyList<Type> InitializationDependencies => new[] { typeof(GameDataManager), typeof(GameSourceManager), typeof(GameRandom), typeof(GameActionManager) };
    ...
    private void ExploreEnd(ExploreEnd exploreEnd)
    {
        ...
        AudioController.instance.ClearBGM(AudioClearType.All, BGMGroup.Battle.ToString());

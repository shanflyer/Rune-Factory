...
public class IOSTest : MonoBehaviour
{
    ...
    public void SharWebUrl()
    {
        ...
        if (GameTimeManager.nowGameTime.gameDate.season ==Season.春&&GameTimeManager.nowGameTime.gameDate.year!=1300)
        {
            notice = LanguageManage.SwitchStr("我已经在这个游戏中度过") +
                (GameTimeManager.nowGameTime.gameDate.year - 1300 )+ LanguageManage.SwitchStr("年了！");
        }

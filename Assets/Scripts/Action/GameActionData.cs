...
{  
    ...
    public void Action(int source=0,int target=0,int value=0, SetResult setResult = null)
    {
        GameActionDataManager.instance.GameAction(typeName, _parameters, source, target,value, setResult);
    }

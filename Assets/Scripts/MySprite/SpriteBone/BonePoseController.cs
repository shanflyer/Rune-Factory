...
#if UNITY_EDITOR
[CustomEditor(typeof(BonePoseController))]
public class BonePoseControllerEditor : Editor
{
    BonePoseController SpriteBonePoseController => target as BonePoseController;

...
{
    private ProFlareBatch _ProFlareBatch;

    // Use this for initialization
    private bool Updated;

    private string occluded = "Occluded";
    ...
    public override void OnInspectorGUI()
    {
        ...
        _ProFlareBatch.flowCamera = EditorGUILayout.Toggle("跟随镜头", _ProFlareBatch.flowCamera);
        _ProFlareBatch.lightTrans = EditorGUILayout.ObjectField("光源", _ProFlareBatch.lightTrans, typeof(Transform), true) as Transform;
        ...
        if (_ProFlareBatch._atlas)
        {
            ...
            _ProFlareBatch.cullingForRay2D = EditorGUILayout.Toggle("2D射线检测", _ProFlareBatch.cullingForRay2D);
            EditorGUILayout.BeginHorizontal();

...
public class ProFlareInspector : Editor
{
    ...
    private GUIStyle thinButton;

    private GUIStyle thinButtonRed;

    private GUIStyle dropDownButton;

    private GUIStyle enumStyleButton;
    ...
    private void CheckUndo()
    {
        ...
        {
            //Debug.Log("record2");
            Undo.RegisterCompleteObjectUndo(target, "Undo ProFlare Change");
            Undo.FlushUndoRecordObjects();

            listeningForGuiChanges = true;
            guiChanged = false;
        }
        else if (listeningForGuiChanges && guiChanged)
        {
            //Debug.Log("record2");
    ...
    public override void OnInspectorGUI()
    {
        ...
        Rect r = EditorGUILayout.BeginVertical("box");
        {
            ...
            if (_flare.EditGlobals)
            {
                ...
                bool currentSunState = _flare.sunMode;
                _flare.sunMode = EditorGUILayout.Toggle("Sun Mode", _flare.sunMode);

                if (_flare.sunMode && ((_flare.sunModeTransformA == null) || _flare.sunModeTransformA == null))
                {
                    if (_flare.sunModeTransformA)
                        DestroyImmediate(_flare.sunModeTransformA);
                    if (_flare.sunModeTransformB)
                        DestroyImmediate(_flare.sunModeTransformB);

                    _flare.setupSunMode();
                }

                if (currentSunState && (_flare.sunMode == false))
                {
                    if (_flare.sunModeTransformA)
                    {
                        DestroyImmediate(_flare.sunModeTransformA.gameObject);
                        _flare.sunModeTransformA = null;
                    }
                    if (_flare.sunModeTransformB)
                    {
                        DestroyImmediate(_flare.sunModeTransformB.gameObject);
                        _flare.sunModeTransformB = null;
                    }
                }
        ...
        if (selectionCount <= 1)
        {
            ...
            if (_flare.EditDynamicTriggering)
            {
                GUILayout.Space(5f);
        ...
        if (selectionCount <= 1)
        {
            ...
            if (_flare.EditOcclusion)
            {
                ...
                _flare.pixelBasedOcclusion = EditorGUILayout.Toggle("Pixel Based Occlusion - BETA", _flare.pixelBasedOcclusion);
                GUI.enabled = _flare.pixelBasedOcclusion;

                _flare.pixelLayerMask = LayerMaskField(_flare.pixelLayerMask);
                //_flare.pixelMask2 = LayerMaskField(_flare.pixelMask2);
                //_flare.pixelMask3 = LayerMaskField(_flare.pixelMask3);
                //_flare.pixelMask4 = LayerMaskField(~(1<<8));
                GUI.enabled = true;

                _flare.occlusionScaleSpeed = EditorGUILayout.FloatField("  Occlusion Scale Speed", _flare.occlusionScaleSpeed);
                _flare.occlusionBrightnessSpeed = EditorGUILayout.FloatField("  Occlusion Brightness Speed", _flare.occlusionBrightnessSpeed);
            }
            EditorGUILayout.EndVertical();
        }
    ...
    private void ElementEditor(ProFlareElement element, int count)
    {
    ...
    private void QuickEdit(ProFlareElement element, int count)
    {
    ...
    private void ElementOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
    ...
    private void ColorOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
        r2.height = 20;
    ...
    private void OffsetOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
        r2.height = 20;
    ...
    private void ScaleOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
        r2.height = 20;
    ...
    private void RotationOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
        r2.height = 20;
    ...
    private void OverrideOptions(ProFlareElement element, int count)
    {
        Rect r = EditorGUILayout.BeginVertical("box");
        Rect r2 = r;
        r2.height = 20;
    ...
    private Texture2D CreateGradientTex(ProFlareElement element, Color c0, Color c1)
    {
    ...
    private ProFlareElement CloneElement(ProFlareElement element)
    {
